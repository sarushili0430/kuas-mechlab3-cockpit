...
const ja = {
    ...
    "console.hint":
        "この画面にフォーカスして W / A / S / D で操縦できます (キーを離すと停止・切断時も機体は自動停止します)",
    "connection.idle": "未接続",
...
const en = {
    ...
    "console.hint":
        "Focus this screen and drive with W / A / S / D (release a key to stop; the robot also stops automatically on disconnect)",
    ...
    "camera.front": "Front",
    "camera.rear": "Rear",
    "keypad.label": "Drive direction indicator",
    "axes.vx": "Fwd/back vx",
    "axes.wz": "Yaw wz",
